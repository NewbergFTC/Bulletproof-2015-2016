...
public class OfficialAutonomousRed extends BulletProofMode{
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while (opModeIsActive()){
            ...
            sleep(10000);
            goTurn(33 , LEFT, LEFT_FRONT_POWER , RIGHT_FRONT_POWER , LEFT_BACK_POWER , RIGHT_BACK_POWER);
            sleep(500);
            goForward(40 , LEFT_FRONT_POWER , RIGHT_FRONT_POWER , LEFT_BACK_POWER , RIGHT_BACK_POWER , 5000);
            sleep(500);
            goTurn(30 , LEFT, LEFT_FRONT_POWER , RIGHT_FRONT_POWER , LEFT_BACK_POWER , RIGHT_BACK_POWER);
            sleep(500);
