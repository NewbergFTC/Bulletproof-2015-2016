 ...
 */
public class OFFICIAL_AUTONOMOUS_BLUE extends LinearOpMode {
        ...
        final double LEFT_MOTOR_POWER = 0.6;
        final double RIGHT_MOTOR_POWER = 0.3;
        ...
        public void runOpMode() throws InterruptedException {
            ...
            while (opModeIsActive()) {
                goForward(42 , LEFT_MOTOR_POWER , RIGHT_MOTOR_POWER);
                sleep(500);
                goTurn(30 , RIGHT, MOTOR_POWER);
                // goForward(20, MOTOR_POWER);
                sleep(500);
                goForward(40 , LEFT_MOTOR_POWER , RIGHT_MOTOR_POWER);
                sleep(500);
        ...
        public void goForward(int inches , double leftPower , double rightPower ) throws InterruptedException {
            ...
            _frontRight.setPower(rightPower);//compensates for right side going to fast
